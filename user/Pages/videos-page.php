...
<head>
  ...
  <title>Browse Videos | SOUND Group</title>
...
<body>
  ...
  <section class="video-hero">
    ...
    <div class="container hero-content">
      <h1 class="section-title">Trending Music Videos</h1>
      <p class="section-subtitle">Discover the most viral and popular music videos taking Instagram by storm</p>
    </div>
  </section>
  ...
  <div class="container">
    ...
    <div class="filter-section">
      <div class="filter-header">
        <h3 class="filter-title">Find Your Favorite Videos</h3>
    ...
    if (mysqli_num_rows($result) > 0) {
      while ($rows = mysqli_fetch_assoc($result)) {
        ...
        echo '
      <div class="col-xl-4 col-lg-6 col-md-6 video-card-container"
      ...
      data-year="' . $rows['year'] . '">
        <div class="video-card" data-bs-toggle="modal" data-bs-target="#videoModal" data-video="' . $rows['link'] . '" >
          ' . $viralBadge . '
          <div class="video-thumbnail">
            <img src="../../admin/uploads/videoscover/' . $rows['image'] . '" alt="' . $rows['title'] . '">
            <div class="play-overlay">
              <div class="play-icon" onclick="location.href=\'video.php?id=' . $rows['id'] . '\'">
          ...
          <div class="video-meta">
            <h4 class="video-title">' . $rows['title'] . '</h4>
            <p class="video-artist">' . $rows['artist'] . '&nbsp; • <span class="song-genre">' . htmlspecialchars($rows['genre']) . '</p>
            <div class="video-stats">
              <div class="video-views">
                <i class="bi bi-eye-fill"></i> 1.2B views 
              </div>
              <div class="video-likes">
                <i class="bi bi-heart-fill"></i> 18M likes
              </div>
            </div>
          </div>
        </div>
  ...
  function filterVideos() {
    ...
    const artistVal = artistFilter.value.toLowerCase().trim();
    const albumVal = albumFilter.value.toLowerCase().trim();
    const genreVal = genreFilter.value.toLowerCase().trim();
    const languageVal = languageFilter.value.toLowerCase().trim();
    ...
    videoCards.forEach(card => {
      ...
      const matchSearch = !searchTerm || name.includes(searchTerm) || artist.includes(searchTerm);
      const matchArtist = !artistVal || artist === artistVal;
      const matchAlbum = !albumVal || album === albumVal;
      const matchGenre = !genreVal || genre === genreVal;
      const matchLanguage = !languageVal || language === languageVal;
      const matchYear = !yearVal || year === yearVal;

      const isVisible = matchSearch && matchArtist && matchAlbum && matchGenre && matchLanguage && matchYear;
  ...
  // Event Listeners
  applyBtn.addEventListener('click', filterVideos);
