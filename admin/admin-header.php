...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="dashboard.php" data-page="dashboard-diff" >Dashboard</a></li>
          <li class="nav-item"><a class="nav-link songslink" href="users.php" data-page="users-diff" >Users</a></li>
          <li class="nav-item"><a class="nav-link" href="artists.php" data-page="artists-diff" >Artists</a></li>
          <li class="nav-item"><a class="nav-link" href="songs.php" data-page="songs-diff" >Songs</a></li>
          <li class="nav-item"><a class="nav-link" href="albums.php" data-page="albums-diff" >Albums</a></li>
          <li class="nav-item"><a class="nav-link" href="videos.php" data-page="videos-diff" >Videos</a></li>
          <li class="nav-item"><a class="nav-link" href="reviews.php" data-page="reviews-diff" >Reviews</a></li>
        </ul>
  ...
  if (window.innerWidth < 800) {
    document.querySelectorAll('.nav-link[data-page]').forEach(link => {
      ...
      if (value.endsWith('-diff')) {
        link.setAttribute('data-page', value.replace('-diff', ''));
      }
    });
  }
});
...
const currentPage = (pageMap[currentFile] ? pageMap[currentFile] + '-diff' : '');
console.log(currentPage)
const navLinks = document.querySelector('[data-page="' + currentPage + '"]');
